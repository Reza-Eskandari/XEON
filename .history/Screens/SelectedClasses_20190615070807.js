...
class SectionScreen extends Component {
  ...
  render() {
    ...
    const section2 = navigation.getParam("section"); //NOTE This is how we use the Card's data(each item in the cars array in AccountScreen) when the SectionScreen loads
    return (
