...
class SelectedClasses extends Component {
  ...
  render() {
    ...
    return (
      ...
      <Container style={{ backgroundColor: selected.colormain }}>
        ...
        <ComponentsContainer>
          ...
          />
          <StudyComponent
            title={components[2].title}
            image={components[2].image}
            logo={components[2].logo}
            onPress={() => {
              this.props.navigation.push(selected.screenFindTutor, {
                ft: components[2]
              });
            }}
          />
