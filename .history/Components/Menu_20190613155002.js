...
const Container = styled.View`
  ...
  overflow: hidden;
  border-bottom-right-radius: ${screenHeight - 200 / 2};
  border-bottom-left-radius: ${screenHeight - 200 / 2};
`;
...
const Cover = styled.View`
  ...
  align-items: center;
  border-bottom-right-radius: 142 / 2;
  border-bottom-left-radius: 142 / 2;
  overflow: hidden;
`;
