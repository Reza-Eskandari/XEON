...
function mapDipatchToProps(dipatch) {
  return {
    closeMenu: () => dipatch({ type: "CLOSE_MENU" }),
...
//NOTE Dynamically adding the icons, titles and text we want in the Content - this is calling the {props.whatever} in MenuItem component
const menuItems = [
  {
    icon: "ios-settings",
    title: "Account",
