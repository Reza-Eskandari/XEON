...
//NOTE Redux - In order to use the InitialState in App.js we have make those states in App.js to props
function mapStateToProps(state) {
  //NOTE connecting the "action" in InitialState making it a prop here
  return { action: state.action };
}

//NOTE Redux - In order to have the close-button call the closeMenu we have to make the state to props
