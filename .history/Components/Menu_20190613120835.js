...
//NOTE Redux - In order to use the InitialState in App.js we have to write the following function
function mapStateToProps(state) {
  //NOTE connecting the "action" in InitialState
...
class Menu extends Component {
  ...
  //NOTE componentDidMount = yeho eine kirekhar load kon
  componentDidMount() {
    this.opencloseMenu();
  }
...
//NOTE we used connect(mapStateToProps) to connect the Menu page with App.js
