...
const CoursesStack = createStackNavigator(
  {
    Courses: CourseScreen, //NOTE this says when user presses on the Account button it'll take him to the AccountScreen
    Section2: SectionScreen //NOTE this says when user presses on the Cards it'll take him to the SectionScreen
  },
  { mode: "modal" } //NOTE this makes the SectionScreen to appaer from bottop-up (by default is right-left)
);
//NOTE Adjusting the settings of the Account button
